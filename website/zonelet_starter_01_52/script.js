...
let blogName = "WCFM Blog";
let authorName = "Lauren Hall";
...
[ "zonelet_starter_01_52/posts/2020-11-10-Post-Template.html" ] ];
...
let headerHTMLL = '<ul> <li><a href="zonelet_starter_01_52/index.html">Home</a></li>' + 
'<li><a href="zonelet_starter_01_52/archive.html">Archive</a></li>';
...
let footerHTMLL = "<p>" + blogName + " maintained by <a href='" + authorLink + "'>" + authorName + "</a> and built with <a href='https://zonelets.net/'>Zonelets</a>.</p>";
...
if (document.getElementById("header")) {
  document.getElementById("header").innerHTML = headerHTMLL;
}
...
if (document.getElementById("footer")) {
  document.getElementById("footer").innerHTML = footerHTMLL;
}
